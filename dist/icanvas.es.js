...
function (_BaseTexture) {
  _inherits(CanvasTexture, _BaseTexture);
...
function (_CanvasTexture) {
  ...
  function FontTexture(canvas, family, weight, size) {
    ...
    _this2 = _possibleConstructorReturn(this, _getPrototypeOf(FontTexture).call(this, canvas));
...
function () {
  function WebGLRender(options) {
    ...
    _defineProperty(this, "text", this.draw);
